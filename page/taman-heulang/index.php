    ...
    <body>
     ...
     <div class="main-banner" id="top">
        <video autoplay muted loop id="bg-video">
            <source src="../../assets/images/heulang.mp4" type="video/mp4" />
        </video>

        <div class="video-overlay header-text">
            <div class="caption">
                <h2>TAMAN HEULANG <em>BOGOR </em></h2>
            </div>
        </div>
    </div>
            ...
            <div class="row" id="tabs">
              ...
              <div class="col-lg-8">
                <section class='tabs-content'>
                  <article id='tabs-1'>
                    <h4>Taman Heulang Bogor</h4>
                    <p>Selain sebagai penyejuk, taman kota bisa menjadi tujuan rekreasi sekaligus 
                      wisata murah meriah bagi warganya. Salah satu taman kota yang selalu ramai 
                      dikunjungi ialah Taman Heulang yang berlokasi di pusat Kota Bogor. Taman yang 
                      diresmikan pada tahun 2016 ini seringkali menjadi tempat terbuka untuk berkumpul 
                      maupun bersantai bagi warga Kota Bogor. Seperti taman kota pada umumnya, taman ini 
                      tidak memberlakukan biaya atau tiket masuk. Pengunjung bisa menikmati seluruh fasilitas 
                      di taman tersebut secara gratis. <br><br>

                      Akses ke lokasi Taman Heulang ini juga cukup mudah. Jika berangkat dari Jakarta, masuk tol
                      Jagorawi, nanti akan melewati kawasan perindustrian wika, kemudian masih terus hinggga keluar
                      menuju tanah baru/sukaraja. Selanjutnya Anda dapat menggunakan navigasi online map. Lokasi nya
                      juga bersebelahan dengan langsung dengan SMK Negeri 1 Bogor dan tepat di belakang SMP Negeri 5 Bogor. <br><br>

                      Fasilitas yang disediakan pun cukup lengkap termasuk musholla, kamar mandi umum, hingga tempat
                      sampah untuk berbagai jenis sampah. Selain dikunjungi pada saat hari terang (pagi, siang ,sore),
                      ternyata Taman Heulang ini juga memiliki daya tarik ketika pada saat malam hari.
                    </p>
                  </article>
                  ...
                  <article id='tabs-3'>
                    <div id="map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.6186490037207!2d106.80010601477093!3d-6.569721095248539!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c43c4d9f6e9f%3A0x7494ee2a6fb643fa!2sTaman%20Heulang!5e0!3m2!1sid!2sid!4v1629474982538!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                  </article>
                  <article id='tabs-4'>
                    <h4>Kontak</h4>
              ...
              <ul class="social-list"> 
                  <a href="https://www.instagram.com/tamanheulang/" target="_blank">
                    <li>
                  ...
                  <a href="https://web.facebook.com/rassyaabiwafa/" target="_blank">
                    <li>
